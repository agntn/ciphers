...
export const OPTION_DESCRIPTIONS = {
  ...
  key: 'Keyword, or a hex key: 32, 48 or 64 digits for aes, aes-cbc, aes-cfb, aes-ofb, aes-ctr, aes-ccm, aes-ocb and aes-cbc-mac, 64, 80 or 96 for aes-lrw, 64 or 128 for aes-xts, 32, 40, 48, 56 or 64 for rijndael, 16 for des, 32 or 48 for triple-des and triple-des-cbc, 8 to 112 (an even number) for blowfish. Required by vigenere, beaufort, autokey, alberti, playfair, columnar, aes, aes-cbc, aes-cfb, aes-ofb, aes-ctr, aes-ccm, aes-ocb, aes-lrw, aes-xts, aes-cbc-mac, rijndael, des, triple-des, triple-des-cbc and blowfish; optional for polybius, adfgvx and bifid',
