...
> = {
  ...
  autokey: { icon: "i-solar-key-linear", blurb: "The plaintext extends the primer key", sample: "ATTACK AT DAWN", options: { key: "QUEENLY" } },
  ...
  "aes-ofb": { icon: "i-solar-lock-password-linear", blurb: "AES fed its own output, a keystream that never sees the text", sample: "ATTACK AT DAWN", options: { key: "2b7e151628aed2a6abf7158809cf4f3c", iv: "ffeeddccbbaa99887766554433221100" } },
  ...
  desx: { icon: "i-solar-lock-password-linear", blurb: "DES between two XORs, 184 key bits for the price of one pass", sample: "ATTACK AT DAWN", options: { key: "0123456789abcdeff0e1d2c3b4a596871122334455667788" } },
