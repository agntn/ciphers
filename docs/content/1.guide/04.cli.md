...
| --- | --- | --- |
| `--shift <n>` | `-s` | caesar |
| `--key <word>` | `-k` | vigenere, beaufort, autokey, alberti, playfair, polybius, columnar, adfgvx, bifid, aes, aes-cbc, aes-cfb, aes-ofb, aes-ctr, aes-ccm, aes-ocb, aes-lrw, rijndael, triple-des and triple-des-cbc (hex) |
