...
const CHIPS = ["cipher_encode", "cipher_decode", "cipher_brute_caesar", "cipher_frequency", "cipher_info"];
</script>
  ...
  >
    <div
      ...
      style="
        background-image: radial-gradient(
          ellipse at top left,
          rgba(240, 171, 252, 0.16) 0%,
          rgba(240, 171, 252, 0.05) 45%,
          transparent 70%
        );
      "
    />
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex items-center">
        <div class="w-[10px] h-[10px] rounded-full" style="background-color: #f0abfc" />
        <p
