...
AES, AES-CBC, AES-CFB, AES-OFB, AES-CTR, AES-CCM, AES-LRW and Triple DES are the exception. They encrypt the UTF-8 bytes of the text as they are and ignore both.
