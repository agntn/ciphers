...
| --- | --- | --- |
| `--shift <n>` | `-s` | caesar |
| `--key <word>` | `-k` | vigenere, beaufort, autokey, alberti, playfair, polybius, columnar, adfgvx, bifid, aes, aes-cbc, aes-cfb, aes-lrw and triple-des (hex) |
| `--transposition <word>` | | adfgvx |
| `--iv <hex>` | | aes-cbc, aes-cfb |
