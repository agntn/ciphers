...
const familyChecks = [
  ...
  `${capitalize(counted(familySize("fractionation"), "fractionation"))} from Polybius to ADFGVX, ${counted(familySize("transposition"), "transposition")}, one Enigma M3, AES and Triple DES in ECB mode, AES in CBC, CFB, OFB, CTR, CCM, OCB and LRW`,
