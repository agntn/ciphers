...
export default defineCommand({
  ...
  args: {
    ...
    key: {
      type: 'string',
      description:
        'Keyword for keyed ciphers, hex digits for AES, AES-CBC, AES-CFB, AES-OFB, AES-CTR, AES-CCM, AES-OCB, AES-LRW, AES-XTS, AES-CBC-MAC, Rijndael, Triple DES, Triple DES CBC and Blowfish',
      alias: 'k',
    },
