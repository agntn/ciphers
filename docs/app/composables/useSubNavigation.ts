...
const NAV_ICONS: Record<string, string> = {
  ...
  "/guide/transform": "i-solar-transfer-horizontal-linear",
  "/guide/analysis": "i-solar-chart-linear",
  "/guide/cli": "i-solar-code-square-linear",
  "/guide/agents": "i-solar-bot-linear",
  "/guide/custom": "i-solar-add-circle-linear",
  "/guide/playground": "i-solar-tuning-2-linear",
  "/ciphers": "i-solar-library-linear",
  "/playground": "i-solar-tuning-2-linear",
