...
The panels on the [home page](/) walk through the twenty-four ciphers with one sample sentence each, computed the same way, in the browser, on one clock. Hover a panel to pause it. The arrows under the code step it by hand.
