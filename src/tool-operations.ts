...
export const OPTION_DESCRIPTIONS = {
  ...
  key: 'Keyword, or a hex key: 32, 48 or 64 digits for aes, aes-cbc, aes-cfb, aes-ofb, aes-ctr, aes-ccm and aes-ocb, 64, 80 or 96 for aes-lrw, 32 or 48 for triple-des and triple-des-cbc. Required by vigenere, beaufort, autokey, alberti, playfair, columnar, aes, aes-cbc, aes-cfb, aes-ofb, aes-ctr, aes-ccm, aes-ocb, aes-lrw, triple-des and triple-des-cbc; optional for polybius, adfgvx and bifid',
