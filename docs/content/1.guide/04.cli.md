...
| `ciphers brute <text>` | All 25 Caesar shifts, best `--lang` fit first (`en`, `pl`, `ja`) |
...
| --- | --- | --- |
| `--shift <n>` | `-s` | caesar |
| `--key <word>` | `-k` | vigenere, beaufort, autokey, alberti, playfair, polybius, columnar, adfgvx, bifid and every `block` cipher (hex) |
