...
AES, AES-CBC, AES-CFB, AES-OFB, AES-CTR, AES-CCM, AES-OCB, AES-LRW, AES-XTS, AES-CBC-MAC, Rijndael, Triple DES and Triple DES CBC are the exception. They encrypt the UTF-8 bytes of the text as they are and ignore both.
